...
This file contains the compiled version of the ArcGIS Viewer for Flex 3.0.
...
Flex Viewer: http://resourcesbeta.arcgis.com/en/communities/flex-viewer/
Flex API http://resourcesbeta.arcgis.com/en/communities/flex-api/
